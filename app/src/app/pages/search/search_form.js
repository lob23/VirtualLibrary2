  ...
  return (
    <>
      <div class="relative w-screen h-screen bg-cream">
        <div class="relative z-40 mx-40 my-40 rounded-md flex items-center h-12 rounded-lg bg-white overflow-hidden shadow-md shadow-blue-500/50">
          ...
          <div class="z-10">
          <div class="absolute -top-[-50px] -right-[20px]  w-[250px] h-[250px]">
              <img
                class="object-contain w-full h-full  "
                src="/image/reg_cir.png"
              ></img>
            </div>
          <div class="absolute top-[20px] left-[-120px]  w-[300px] h-[300px]">
              <img
                class="object-contain w-full h-full "
                src="/image/reg_cir.png"
              ></img>
            </div>
          <div class="absolute top-[120px] left-[120px]  w-[150px] h-[150px]">
              <img
                class="object-contain w-full h-full "
                src="/image/reg_cir.png"
              ></img>
