        ...
        <>
            <div className="relative w-full h-[480px] px-[70px] bg-blue bg-fixed">\
                    ...
                    <div className="flex flex-col static w-[250px] h-auto px-5 py-[73px]">
                        ...
                        <div className="row-span-3 flex flex-row gap-x-10 w-full h-[50px] py-5">
                            ...
                            <span 
                                className="object-cover w-auto h-auto bg-transparent border-none">
                                    <svg width="40" height="40" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M37.1882 4.00244H43.9352L29.1951 20.8494L46.5356 43.7744H32.9581L22.3237 29.8705L10.1555 43.7744H3.40451L19.1705 25.7546L2.53564 4.00244H16.4579L26.0704 16.7111L37.1882 4.00244ZM34.8203 39.736H38.5588L14.4264 7.82871H10.4146L34.8203 39.736Z" fill="white"/>
                                    </svg>
                ...
                <div className="absolute w-full h-auto transform scale-100 md:scale-25">
                    <svg width="1200" height="3" viewBox="0 0 1798 3" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0.311157 1.28174L1797.9 1.28158" stroke="white" stroke-width="2"/>
                    </svg>
                </div>
