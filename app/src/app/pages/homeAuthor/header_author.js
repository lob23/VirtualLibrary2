...
const header_author = () => {
  ...
  const handleLibraryClick = () =>{
    ...
    return(
    <>
      <div className="row-span-3 flex flex-row relative w-screen h-[70px] pl-10 py-2 place-items-center shadow-md bg-transparent">
        ...
        <div className="grid grid-flow-col grid-cols-2 absolute right-2 gap-[40px] w-[100px] h-[100px] mr-[100px] items-center cursor-pointer"
             ...
             title="Notification">
            <div className={`relative col-span-1 w-[25px] h-[25px] hover:opacity-50 ${notiClick ? "opacity-50" : "opacity-100"}`} >
              <svg width="25" height="25" viewBox="0 0 37 40" fill="none" xmlns="http://www.w3.org/2000/svg">
